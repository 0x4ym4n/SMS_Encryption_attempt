...
Uint8List createUnit8ListFromString(String value) => new Uint8List.fromList(utf8.encode(value));
...
String plaintext = 'Your OTP code is: G-23323 from kida kidaaYour OTP code is: G-23323 from kida kidaaYour OTP code is: G-23323 from kida kidaaYour OTP code is: G-23323 from kida kidaa';
Uint8List plaindata  =  createUnit8ListFromString(plaintext);
Uint8List encrypted_data  =  cipher.process(plaindata);
...
displayUint8List("Encrypted_data", encrypted_data);
displayUint8List("Decrypted_data", Decrypted_data);
